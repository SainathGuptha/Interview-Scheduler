...
export default function Resheduler() {
    const { url,getAvailableSlots, fetchDataById, updateData, intervierName } = useContext(DataContext)
        ...
        <div className="flex min-h-screen bg-gray-100">
            ...
            <div className="w-3/4 flex justify-center items-center p-8">
                <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                    <h2 className="text-2xl font-bold mb-6 text-center">Reschedule Interview</h2>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <select name="interviewer" id="interviewer" value={details.interviewer} onChange={handleChange} required className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <button type='submit' className="w-full py-2 px-4 bg-indigo-600 text-white font-semibold rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Reschedule Interview</button>
                </form>
            </div>
        </div>
    );
